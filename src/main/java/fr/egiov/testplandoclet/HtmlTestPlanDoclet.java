...
/**
 * This javadoc doclet creates the test plan from the javadoc of JUnit testcase annoted with
 * specifics tags.
...
public class HtmlTestPlanDoclet extends Doclet
{
   ...
   /** The number of options autorized by this doclet. */
   private static final int AUTORIZED_OPTIONS_NUMBER = 1;
   ...
   {
      return AUTORIZED_OPTIONS_NUMBER;
   }
