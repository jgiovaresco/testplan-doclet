...
public class Log
{
    ...
    * @param p_isDebug The debug flag indicating if the log must be configured with the DEBUG level.
    */
   public static void initLog4j(boolean p_isDebug)
   {
      ...
      props.setProperty("log4j.appender.logfile.layout.ConversionPattern", "%d{yyyy-MM-dd HH:mm:ss.SSS} %5p %C{1}:%M() - %m%n");
